...
Err _read_comments_get_db_results(bson_t **db_results, UUID main_id, time64_t create_milli_timestamp, bool is_ascending, int max_n_comments, bool is_ascending, MongoDBId mongo_db_id, int *n_read_comments);
...
Err int _cmp_ascending(const void *a, const void *b);
Err int _cmp_descending(const void *a, const void *b);
