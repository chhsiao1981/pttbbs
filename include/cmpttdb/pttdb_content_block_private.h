...
Err _construct_contents_from_content_block_infos_mongo_core(UUID orig_content_id, int orig_block_id, UUID new_content_id, enum MongoDBId, mongo_db_id, int *n_line, int *n_block, int *len, char *line, int line_size, int *bytes_in_line, ContentBlock *content_block);

Err _construct_contents_from_content_block_infos_file_core(UUID main_id, PttDBContentType content_type, UUID ref_id, UUID orig_id, int orig_block_id, int file_id, UUID new_id, enum MongoDBId mongo_db_id, int *n_line, int *n_block, int *len, char *line, int line_size, int *bytes_in_line, ContentBlock *content_block);
