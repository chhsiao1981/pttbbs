...
enum PttUIThreadLock {
    ...
    LOCK_PTTUI_THREAD_STATE_DISP_BUFFER,

    LOCK_VEDIT3_EXPECTED_STATE,
    LOCK_VEDIT3_BUFFER_STATE,
    LOCK_VEDIT3_WR_BUFFER_INFO,
    LOCK_VEDIT3_BUFFER_INFO,
    LOCK_VEDIT3_FILE_INFO,
    
    N_PTTUI_THREAD_LOCK,

    LOCK_PTTUI_THREAD_STATE = LOCK_PTTUI_THREAD_STATE_DISP_BUFFER,
};
