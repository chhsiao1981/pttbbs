...
TEST(migrate_merge, migrate_1to3_get_offset_comments_from_origin2) {
    int fi = OpenCreate("tests/test_data/original_post.2.txt", O_RDONLY);
    int offset0 = lseek(fi, 0, SEEK_CUR);
    printf("fi: %d offset0: %d\n", fi, offset0);
    int offset_origin = migrate_1to3_get_offset_origin(fi);
...
TEST(migrate_merge, migrate_1to3_get_offset_comments_from_origin3) {
    int fi = OpenCreate("tests/test_data/original_post.3.txt", O_RDONLY);
    int offset0 = lseek(fi, 0, SEEK_CUR);
    printf("fi: %d offset0: %d\n", fi, offset0);
    int offset_origin = migrate_1to3_get_offset_origin(fi);
...
TEST(migrate_merge, migrate_1to32) {
...
TEST(migrate_merge, migrate_1to33) {
...
TEST(migrate_merge, migrate_1to34) {
...
TEST(migrate_merge, migrate_1to35) {
...
TEST(migrate_merge, migrate_1to36) {
...
TEST(migrate_merge, migrate_1to37) {
...
TEST(migrate_merge, migrate_1to38) {
...
TEST(migrate_merge, migrate_1to39) {
