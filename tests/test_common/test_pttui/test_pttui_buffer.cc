...
TEST(pttui_buffer, sync_pttui_buffer_info_init_buffer_no_buf_from_file_info)
{
    ...
    fprintf(stderr, "test_pttui_buffer.sync_pttui_buffer_info_init_buffer_no_buf_from_file_info: after db force drop\n");
    ...
    fprintf(stderr, "test_pttui_buffer.sync_pttui_buffer_info_init_buffer_no_buf_from_file_info: to sync\n");
    error = _sync_pttui_buffer_info_init_buffer_no_buf_from_file_info(&state, &file_info, &buffer_info);
    fprintf(stderr, "test_pttui_buffer.sync_pttui_buffer_info_init_buffer_no_buf_from_file_info: after sync\n");
    EXPECT_EQ(S_OK, error);
    ...
    error = destroy_pttui_buffer_info(&buffer_info);
    EXPECT_EQ(S_OK, error);

}

TEST(pttui_buffer, sync_pttui_buffer_info_extend_pre_buffer_no_buf_main)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
    ...
    error = _sync_pttui_buffer_info_extend_pre_buffer_no_buf_main(&current_buffer, &file_info, &new_buffer);
    EXPECT_EQ(S_OK, error);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_pre_buffer_no_buf_main2)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_pre_buffer_no_buf_main3)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_pre_buffer_no_buf_comment)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
    ...
    error = _sync_pttui_buffer_info_extend_pre_buffer_no_buf_comment(&current_buffer, &file_info, &new_buffer);
    EXPECT_EQ(S_OK, error);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_pre_buffer_no_buf_comment2)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_pre_buffer_no_buf_comment3)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_pre_buffer_no_buf_comment_reply)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
    ...
    error = _sync_pttui_buffer_info_extend_pre_buffer_no_buf_comment_reply(&current_buffer, &file_info, &new_buffer);
    EXPECT_EQ(S_OK, error);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_pre_buffer_no_buf_comment_reply2)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_pre_buffer_no_buf_comment_reply3)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_pre_buffer_no_buf_comment_reply4)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_next_buffer_no_buf_main)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
    ...
    error = _sync_pttui_buffer_info_extend_next_buffer_no_buf_main(&current_buffer, &file_info, &new_buffer);
    EXPECT_EQ(S_OK, error);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_next_buffer_no_buf_main2)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_next_buffer_no_buf_main3)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_next_buffer_no_buf_main4)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_next_buffer_no_buf_comment)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_next_buffer_no_buf_comment2)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_pre_buffer)
{
    ...
    error = _sync_pttui_buffer_info_extend_pre_buffer(&buffer_info, &state, &file_info, HARD_N_PTTUI_BUFFER);
    EXPECT_EQ(S_OK, error);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_pre_buffer2)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_pre_buffer3)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
...
TEST(pttui_buffer, sync_pttui_buffer_info_extend_next_buffer)
{
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN);
    _DB_FORCE_DROP_COLLECTION(MONGO_MAIN_CONTENT);
    _DB_FORCE_DROP_COLLECTION(MONGO_COMMENT);
    ...
    error = _sync_pttui_buffer_info_extend_next_buffer(&buffer_info, &state, &file_info, HARD_N_PTTUI_BUFFER);
    EXPECT_EQ(S_OK, error);
...
TEST(pttui_buffer, pttui_buffer_info_to_resource_info)
{
    ...
    error = _sync_pttui_buffer_info_extend_next_buffer_no_buf(&buffer_info, &file_info, HARD_N_PTTUI_BUFFER);
    EXPECT_EQ(S_OK, error);
