...
_vedit3_action_move_pgdn_get_expected_top_line_buffer(VEdit3EditorStatus *editor_status, FileInfo *file_info, PttUIState *current_state, PttUIState *expected_state, int *n_next_line)
{
    ...
    if(!error_code) {
        fprintf(stderr, "vedit3_action._vedit3_action_move_pgdn_get_expected_buffer: expected_state: current_type: %d block_offset: %d line_offset: %d comment_offset: %d n_window_line: %d n_next_line: %d\n", expected_state->top_line_content_type, expected_state->top_line_block_offset, expected_state->top_line_line_offset, expected_state->top_line_comment_offset, expected_state->n_window_line, *n_next_line);
    }
    else {
        fprintf(stderr, "vedit3_action._vedit3_action_move_pgdn_get_expected_buffer: e: %d\n", error_code);
    }
...
_vedit3_action_delete_line_core(PttUIBuffer *buffer)
{
    ...
    if (PTTUI_BUFFER_INFO.head == buffer) {
        fprintf(stderr, "vedit3_action._vedit3_action_delete_line_core: delete head: content-type: %d comment-id: %d block-id: %d line-id: %d file-id: %d buf: %s\n", buffer->content_type, buffer->comment_offset, buffer->block_offset, buffer->line_offset, buffer->file_offset, buffer->buf);
    ...
    if (PTTUI_BUFFER_INFO.tail == buffer) {
        fprintf(stderr, "vedit3_action._vedit3_action_delete_line_core: delete tail: content-type: %d comment-id: %d block-id: %d line-id: %d file-id: %d  load-line-id: %d buf: %s\n", buffer->content_type, buffer->comment_offset, buffer->block_offset, buffer->line_offset, buffer->file_offset, buffer->load_line_offset, buffer->buf);
        ...
        if(tmp_5) {
            fprintf(stderr, "vedit3_action._vedit3_action_delete_line_core: tmp-5: is_to_delete: %d content-type: %d comment-id: %d block-id: %d line-id: %d file-id: %d load-line-id: %d buf: %s\n", tmp_5->is_to_delete, tmp_5->content_type, tmp_5->comment_offset, tmp_5->block_offset, tmp_5->line_offset, tmp_5->file_offset, tmp_5->load_line_offset, tmp_5->buf);
        }

        if(tmp_4) {
            fprintf(stderr, "vedit3_action._vedit3_action_delete_line_core: tmp-4: is-to-delete: %d tmp-4: content-type: %d comment-id: %d block-id: %d line-id: %d file-id: %d load-line-id: %d buf: %s\n", tmp_4->is_to_delete, tmp_4->content_type, tmp_4->comment_offset, tmp_4->block_offset, tmp_4->line_offset, tmp_4->file_offset, tmp_4->load_line_offset, tmp_4->buf);
        }

        if(tmp_3) {
            fprintf(stderr, "vedit3_action._vedit3_action_delete_line_core: tmp-3: is-to-delete: %d tmp-3: content-type: %d comment-id: %d block-id: %d line-id: %d file-id: %d load-line-id: %d buf: %s\n", tmp_3->is_to_delete, tmp_3->content_type, tmp_3->comment_offset, tmp_3->block_offset, tmp_3->line_offset, tmp_3->file_offset, tmp_3->load_line_offset, tmp_3->buf);
        }

        if(tmp_2) {
            fprintf(stderr, "vedit3_action._vedit3_action_delete_line_core: tmp-2: is-to-delete: %d tmp-2: content-type: %d comment-id: %d block-id: %d line-id: %d file-id: %d load-line-id: %d buf: %s\n", tmp_2->is_to_delete, tmp_2->content_type, tmp_2->comment_offset, tmp_2->block_offset, tmp_2->line_offset, tmp_2->file_offset, tmp_2->load_line_offset, tmp_2->buf);
        }

        if(tmp_1) {
            fprintf(stderr, "vedit3_action._vedit3_action_delete_line_core: tmp-1: is-to-delete: %d tmp-1: content-type: %d comment-id: %d block-id: %d line-id: %d file-id: %d load-line-id: %d buf: %s\n", tmp_1->is_to_delete, tmp_1->content_type, tmp_1->comment_offset, tmp_1->block_offset, tmp_1->line_offset, tmp_1->file_offset, tmp_1->load_line_offset, tmp_1->buf);
        }
        ...
        while(p_buffer != PTTUI_BUFFER_INFO.tail) {
            ...
            fprintf(stderr, "vedit3_action._vedit3_action_delete_line_core: to-delete: content-type: %d comment-id: %d block-id: %d line-id: %d file-id: %d load-line-id: %d buf: %s\n", p_buffer2->content_type, p_buffer2->comment_offset, p_buffer2->block_offset, p_buffer2->line_offset, p_buffer2->file_offset, p_buffer2->load_line_offset, p_buffer2->buf);

            error_code = pttui_buffer_add_to_delete_buffer_list(p_buffer2, &PTTUI_BUFFER_INFO);
        }
        fprintf(stderr, "vedit3_action._vedit3_action_delete_line_core: delete tail: tail: content-type: %d comment-id: %d block-id: %d line-id: %d file-id: %d load-line-id: %d buf: %s\n", PTTUI_BUFFER_INFO.tail->content_type, PTTUI_BUFFER_INFO.tail->comment_offset, PTTUI_BUFFER_INFO.tail->block_offset, PTTUI_BUFFER_INFO.tail->line_offset, PTTUI_BUFFER_INFO.tail->file_offset, PTTUI_BUFFER_INFO.tail->load_line_offset, PTTUI_BUFFER_INFO.tail->buf);
