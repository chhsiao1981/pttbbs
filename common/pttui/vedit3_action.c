...
vedit3_action_move_pgdn()
{
    ...
    fprintf(stderr, "vedit3_action.vedit3_action_move_pgdn: get expected top line buffer: e: %d n_next_line: %d expected_state: (content_type: %d comment: %d block: %d line: %d)\n", error_code, n_next_line, expected_state.top_line_content_type, expected_state.top_line_comment_offset, expected_state.top_line_block_offset, expected_state.top_line_line_offset);
    if(error_code) return error_code;
