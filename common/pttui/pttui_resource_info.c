...
pttui_resource_info_to_resource_dict(PttUIResourceInfo *resource_info, PttUIResourceDict *resource_dict)
{
    ...
    fprintf(stderr, "pttui_resource_info_to_resource_dict: after get main-from-db: n_queue: %d e: %d\n", p_queue->n_queue, error_code);
    ...
    fprintf(stderr, "pttui_resource_info_to_resource_dict: after get main-from-file: n_queue: %d e: %d\n", p_queue->n_queue, error_code);
    if(error_code) return error_code;
    ...
    fprintf(stderr, "pttui_resource_info_to_resource_dict: after get comment-from-db: n_queue: %d e: %d\n", p_queue->n_queue, error_code);
    if(error_code) return error_code;
    ...
    fprintf(stderr, "pttui_resource_info_to_resource_dict: after get comment-from-file: n_queue: %d e: %d\n", p_queue->n_queue, error_code);
    if(error_code) return error_code;
    ...
    fprintf(stderr, "pttui_resource_info_to_resource_dict: after get comment-reply-from-db: n_queue: %d e: %d\n", p_queue->n_queue, error_code);
    if(error_code) return error_code;
    ...
    fprintf(stderr, "pttui_resource_info_to_resource_dict: after get comment-reply-from-file: n_queue: %d e: %d\n", p_queue->n_queue, error_code);
    if(error_code) return error_code;
