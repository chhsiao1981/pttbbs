...
void test3(char *find_key) {
    ...
    bson_append_binary(val, "test2", -1, BSON_SUBTYPE_BINARY, (uint8_t *)"temp23", 6);
    ...
    bson_append_binary(key2, "test", -1, BSON_SUBTYPE_BINARY, (uint8_t *)"temp3", 5);
